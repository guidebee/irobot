...
import com.guidebee.irobot.model.Codec;
import com.guidebee.irobot.model.CodecOption;
import com.guidebee.irobot.model.ConfigurationException;
import com.guidebee.irobot.model.Size;
import com.guidebee.irobot.util.CodecUtils;
import com.guidebee.irobot.util.IO;
...
public class SurfaceEncoder implements AsyncProcessor {
    ...
    private static MediaFormat createFormat(String videoMimeType, int bitRate, float maxFps, List<CodecOption> codecOptions) {
        ...
        if (maxFps > 0) {
            ...
            // <https://github.com/guidebee/irobot/issues/488#issuecomment-567321437>
    ...
    public void start(TerminationListener listener) {
        thread = new Thread(() -> {
            ...
            // <https://github.com/guidebee/irobot/issues/4143>
            Looper.prepare();
