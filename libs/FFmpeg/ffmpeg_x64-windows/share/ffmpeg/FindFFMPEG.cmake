...
if (NOT FFMPEG_FOUND)
    ...
    if (FFMPEG_libavutil_FOUND)
        ...
        set(FFMPEG_libavutil_VERSION "56.70.100" CACHE STRING "")

        if (FFMPEG_libavcodec_FOUND)
            set(FFMPEG_libavcodec_VERSION "58.134.100" CACHE STRING "")
        endif ()
        if (FFMPEG_libavdevice_FOUND)
            set(FFMPEG_libavdevice_VERSION "58.13.100" CACHE STRING "")
        endif ()
        if (FFMPEG_libavfilter_FOUND)
            set(FFMPEG_libavfilter_VERSION "7.110.100" CACHE STRING "")
        endif ()
        if (FFMPEG_libavformat_FOUND)
            set(FFMPEG_libavformat_VERSION "58.76.100" CACHE STRING "")
        endif ()
        if (FFMPEG_libavresample_FOUND)
            set(FFMPEG_libavresample_VERSION "4.0.0" CACHE STRING "")
        endif ()
        if (FFMPEG_libswresample_FOUND)
            set(FFMPEG_libswresample_VERSION "3.9.100" CACHE STRING "")
        endif ()
        if (FFMPEG_libswscale_FOUND)
            set(FFMPEG_libswscale_VERSION "5.9.100" CACHE STRING "")
        endif ()

        append_dependencies(FFMPEG_DEPS_LIBRARY_RELEASE NAMES "")
        append_dependencies(FFMPEG_DEPS_LIBRARY_DEBUG NAMES "" DEBUG)
